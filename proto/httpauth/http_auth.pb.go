...
var file_http_auth_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x07, 0x74, 0x72, 0x61, 0x63, 0x65, 0x49, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x75,
...
var file_http_auth_proto_depIdxs = []int32{
	2, // 0: demo.httpauth.LoginResponse.data:type_name -> demo.httpauth.LoginResponse.Data
	0, // 1: demo.httpauth.Auth.Login:input_type -> demo.httpauth.LoginRequest
	1, // 2: demo.httpauth.Auth.Login:output_type -> demo.httpauth.LoginResponse
